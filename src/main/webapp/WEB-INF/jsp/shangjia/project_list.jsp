...
<div class="table-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="${pageContext.request.contextPath}/shangjia/project/add" class="btn btn-warning text-white">
            ...
            <tbody>
                <c:forEach items="${list}" var="p">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/shangjia/project/edit/${p.id}" class="btn btn-sm btn-outline-primary">编辑</a>
                            <a href="${pageContext.request.contextPath}/shangjia/project/delete/${p.id}" class="btn btn-sm btn-outline-danger" onclick="return confirm('确认删除？')">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
