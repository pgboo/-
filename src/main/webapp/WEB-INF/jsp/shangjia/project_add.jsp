...
<div class="table-card">
    ...
    <form action="${pageContext.request.contextPath}/shangjia/project/save" method="post" enctype="multipart/form-data">
        <div class="row">
        ...
        <button type="submit" class="btn btn-warning text-white">发布</button>
